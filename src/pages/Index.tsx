  ...
  return (
    <main className="min-h-screen overflow-hidden bg-gradient-bloom">
      ...
      <section id="about" className="border-t border-border bg-leaf py-14 text-primary-foreground">
        <div className="mx-auto max-w-7xl px-5"><h2 className="font-display text-4xl font-bold">About page</h2><p className="mt-3 max-w-3xl text-primary-foreground/85">Luxe & Loom demonstrates a functional deployed jewelry website with a home page, catalog page, management page, order form page, responsive design, live data storage, request handling, and publish-ready hosting.</p></div>
      </section>
    </main>
  );
};
